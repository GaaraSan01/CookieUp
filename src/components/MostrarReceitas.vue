...
import { itensDeLista1EstaoEmLista2 } from '../functions/lista';
...
export default {
    ...
    async created() {
        ...
        this.receitasEncontradas = receitas.filter((receita) => {
            // Lógica que verifica de posso fazer a receita:
            /*
                Todos os ingredientes de uma receita deve estar na minha lista de ingredientes
